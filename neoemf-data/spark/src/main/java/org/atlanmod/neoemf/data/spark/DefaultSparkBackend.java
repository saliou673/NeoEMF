...
/**
 * The default {@link SparkBackend} mapping.
 *
 * @see SparkBackendFactory
 */
@ParametersAreNonnullByDefault
class DefaultSparkBackend extends AbstractSparkBackend {

    /**
     * Constructs a new {@code DefaultSparkBackend}.
     *
     * @see SparkBackendFactory
     */
    protected DefaultSparkBackend() {
        super();
