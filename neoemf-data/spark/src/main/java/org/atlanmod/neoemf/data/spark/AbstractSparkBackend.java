...
/**
 * An abstract {@link SparkBackend} that provides overall behavior for the management of a Spark
 * database.
 */
@ParametersAreNonnullByDefault
abstract class AbstractSparkBackend extends AbstractBackend implements SparkBackend {

    /**
     * Constructs a new {@code AbstractSparkBackend}.
     */
    protected AbstractSparkBackend() {
